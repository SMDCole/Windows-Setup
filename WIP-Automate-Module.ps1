Write-Host "Location ID's are as follows: "
Import-Csv -Path "C:\Users\cole\Windows-Setup\Clients.csv" | Format-Table
$LocID = Read-Host "Enter the location ID of the Client to assign Automate to: "
Write-Output $LocID

Install-Automate -Server 'systemsmd.hostedrmm.com' -LocationID $LocID -Token 'adb68881994ed93960346478303476f4'
